    ...
    <div style={{ padding: '2rem', fontFamily: 'Segoe UI, sans-serif' }}>
      ...
      <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, minWidth: '350px', padding: '1rem', background: '#fff', borderRadius: '10px' }}>
          ...
          <div className="mt-2">
            <p><strong>Total Kehadiran:</strong> {totalGuruHadir}</p>
            <p><strong>Izin:</strong> {totalGuruIzin}</p>
            <p><strong>Tidak Hadir:</strong> {totalGuruTH}</p>
            <p><strong>Persentase Hadir:</strong> {persenHadir}%</p>
          </div>
        </div>
      </div>
    </div>
